...
def extract_features(file_path, feature_types, k=None):
    """
    Extracts features from a FASTA file.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature_types', nargs='+', required=True, 
                        choices=['amino_acid_composition', 'dipeptide_composition', 'kmer_frequencies', 'physicochemical'],
    ...
    df = extract_features(args.input, args.feature_types, args.k)
